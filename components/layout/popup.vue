<template>
  <div id="js-popup" class="popup">
    <div class="popup__overlay js-open-popup"></div>
    <div class="popup__main">
      <button class="btn close popup__close js-open-popup" title="Close">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <form action="php/mail.php" method="post" class="popup__form js-form-val">
        <input
          type="email"
          name="email"
          class="input popup__input js-val"
          placeholder="Enter your email"
        />
        <div class="row-form__error static">
          <span class="icn">
            <svg
              width="20"
              height="20"
        ...
        <button class="btn btn_l btn_black popup__submit" type="submit">
          Joint waitlist
          <svg
            width="6"
            height="10"
        ...
        <div class="row-form__ready static white">
          <span class="icn">
            <svg
              width="20"
              height="20"
