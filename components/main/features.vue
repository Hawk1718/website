          ...
          <div class="flex">
              ...
              >
                <defs>
                  <linearGradient
                    ...
                    y2="102.613%"
                  >
                    <stop offset="0%" stop-color="#C8DCFF"></stop>
                  ...
                  <linearGradient
                    ...
                    y2="102.613%"
                  >
                    <stop offset="0%" stop-color="#FF00CA"></stop>
                    <stop offset="100%" stop-color="#0075FF"></stop>
                  </linearGradient>
                </defs>
                <g fill="none" fill-rule="nonzero">
                  <path
                    fill="url(#decentralized-a)"
                    d="M26.154 20a6.154 6.154 0 0 1-12.308 0c0-3.398 3.077-6.154 6.154-6.154V20h6.154z"
                  ></path>
                  <path
                    fill="url(#decentralized-b)"
                    d="M20 0C8.972 0 0 8.972 0 20s8.972 20 20 20 20-8.972 20-20S31.028 0 20 0zm0 38.462C9.82 38.462 1.538 30.179 1.538 20 1.538 9.82 9.82 1.538 20 1.538S38.462 9.821 38.462 20c0 10.18-8.283 18.462-18.462 18.462z"
                  ></path>
                  <path
                    fill="url(#decentralized-b)"
                    d="M20 4.615h-.77v2.347A13.03 13.03 0 0 0 6.924 20c0 7.21 5.866 13.077 13.077 13.077 6.952 0 12.636-5.455 13.038-12.308h2.347V20c0-8.34-7.046-15.385-15.385-15.385zm0 26.923c-6.362 0-11.538-5.176-11.538-11.538 0-6.103 4.615-11.1 10.769-11.5v12.27h12.268C31.101 26.772 26.103 31.537 20 31.537zm.77-12.307V6.176c6.922.4 12.654 6.145 13.053 13.055H20.77z"
                  ></path>
                </g>
              </svg>
            </div>
            <div class="w-3/4">
              ...
              <p class="text-blue-200 text-sm mt-3">
                Unlike other decentralized exchanges, Injective is truly
                decentralized and does not have any centralized component. Take
                back control of your funds and trade through our peer-to-peer
                client. You can see your orders posted and matched on the
                sidechain in real time.
              </p>
            </div>
          </div>
        </div>
              ...
              >
                <defs>
                  ...
                  >
                    ...
                    <stop offset="100%" stop-color="#00F93E"></stop>
                  </linearGradient>
                </defs>
                <path
                  fill="url(#trading-a)"
                  fill-rule="nonzero"
                  d="M37.692 30.476H40V32H0v-1.524h2.308V23.62h1.538v6.857h3.077v-3.81h1.539v3.81h3.076v-16h1.539v16h3.077V23.62h1.538v6.857h3.077V19.81h1.539v10.666h4.615V16.762h1.539v13.714h3.076V11.43h1.539v19.047h3.077v-16h1.538v16zM34.471.05c.994-.274 1.909.632 1.633 1.616l-1.105 3.945a.667.667 0 0 1-1.111.29l-1.303-1.29-8.327 8.25a3.876 3.876 0 0 1-5.439 0l-4.88-4.834a2.325 2.325 0 0 0-3.263 0l-7.055 6.988-1.088-1.077 7.055-6.989a3.876 3.876 0 0 1 5.439 0l4.88 4.834c.9.891 2.363.891 3.263 0l8.328-8.249-1.303-1.29a.656.656 0 0 1 .293-1.1L34.47.05z"
                ></path>
              </svg>
            </div>
            <div class="w-3/4">
              <h3 class="text-xl font-bold">Cryptographically Secure</h3>
              <p class="text-blue-200 text-sm mt-3">
                We leverage the bleeding edge of cryptography and decentralized
                finance to make your trading experience secure. Injective is the
                only DEX protocol securing your trades against front-running
                using Verifiable Delay Functions (VDFs) and selective delay.
              </p>
            </div>
          </div>
        </div>
              ...
              >
                <defs>
                  ...
                  >
                    ...
                    <stop offset="100%" stop-color="#E6ABFF"></stop>
                  </linearGradient>
                  <linearGradient
                    id="adaptable-b"
                    x1="50%"
                  ...
                  >
                    <stop offset="0%" stop-color="#C8DCFF"></stop>
                    <stop offset="100%" stop-color="#C822FF"></stop>
                  </linearGradient>
                  <linearGradient
                    id="adaptable-d"
                    x1="50%"
