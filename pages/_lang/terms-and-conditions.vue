  ...
  <article class="article">
    <div class="container">
      <div class="article__wrap">
        ...
        <p>
          The websites located at<a href="http://injectiveprotocol.com">
            injectiveprotocol.com</a
          >
          and injective.exchange (the “Sites”) is copyrighted work belonging to
          Injective Labs Inc. (“Company”, “us”, “our”, and “we”). Certain
          features of the Sites may be subject to additional guidelines, terms,
          or rules, which will be posted on the Sites in connection with such
        ...
        <p>
          ...
          AND CONDITIONS THAT GOVERN YOUR USE OF THE SITES. BY ACCESSING OR
          USING THE SITES, YOU ARE ACCEPTING THESE TERMS (ON BEHALF OF YOURSELF
          ...
          ACCESS OR USE THE SITES OR ACCEPT THE TERMS IF YOU ARE NOT AT LEAST 18
          YEARS OLD. IF YOU DO NOT AGREE WITH ALL OF THE PROVISIONS OF THESE
          TERMS, DO NOT ACCESS AND/OR USE THE SITES.THESE TERMS REQUIRE THE USE
          OF ARBITRATION (SECTION 8.2) ON AN INDIVIDUAL BASIS TO RESOLVE
        ...
        <p>
          Account Creation: In order to use certain features of the Sites, you
          may have to register for an account (“Account”) and provide certain
          ...
          the accuracy of such information.Account Responsibilities: You are
          ...
          under your Account. Company cannot and will not be liable for any loss
          or damage arising from your failure to comply with the above
          requirements.
        </p>
        <p><strong>2. ACCESS TO THE SITES</strong></p>
        <p>
          License: Subject to these Terms, Company grants you a
          non-transferable, non-exclusive, revocable, limited license to use and
          access the Sites solely for your own personal, noncommercial use.<br />Certain
          ...
          exploit the Sites, whether in whole or in part, or any content
          displayed on the Sites; (b) you shall not modify, make derivative
          works of, disassemble, reverse compile or reverse engineer any part of
          the Sites; (c) you shall not access the Sites in order to build a
          similar or competitive websites, product, or service; and (d) except
          as expressly stated herein, no part of the Sites may be copied,
          ...
          Sites shall be subject to these Terms. All copyright and other
          proprietary notices on the Sites (or on any content displayed on the
          Sites) must be retained on all copies thereof.<br />Modification:
          Company reserves the right, at any time, to modify, suspend, or
          discontinue the Sites (in whole or in part) with or without notice to
          ...
          Sites or any part thereof.<br />No Support or Maintenance. You
          ...
          Sites.Ownership. You acknowledge that all the intellectual property
          rights, including copyrights, patents, trade marks, and trade secrets,
          in the Sites and its content are owned by Company or Company’s
          suppliers. Neither these Terms (nor your access to the Sites)
        ...
        <p>
          ...
          your use of the Sites, (b) your violation of these Terms or (c) your
          violation of applicable laws or regulations. Company reserves the
        ...
        <p><strong>4. THIRD-PARTY LINKS &amp; ADS; OTHER USERS</strong></p>
        <p>
          ...
          any transaction in connection with such Third-Party Links &amp;
          Ads.<br />Other Users. Your interactions with other Sites users are
          solely between you and such users. You agree that Company will not be
          responsible for any loss or damage incurred as the result of any such
          interactions. If there is a dispute between you and any Sites user, we
          are under no obligation to become involved.<br />Release. You hereby
          ...
          out of, or that relates directly or indirectly to, the Sites
          (including any interactions with, or act or omission of, other Sites
          users or any Third-Party Links &amp; Ads).
        </p>
        <p><strong>5. DISCLAIMERS</strong></p>
        <p>
          THE SITES IS PROVIDED ON AN “AS-IS” AND “AS AVAILABLE” BASIS, AND
          ...
          SITES WILL MEET YOUR REQUIREMENTS, WILL BE AVAILABLE ON AN
          ...
          TO THE SITES, ALL SUCH WARRANTIES ARE LIMITED IN DURATION TO NINETY
          (90) DAYS FROM THE DATE OF FIRST USESOME JURISDICTIONS DO NOT ALLOW
        ...
        <p><strong>6. LIMITATION ON LIABILITY</strong></p>
        <p>
          ...
          OF, OR INABILITY TO USE, THE SITES, EVEN IF COMPANY HAS BEEN ADVISED
          OF THE POSSIBILITY OF SUCH DAMAGES. ACCESS TO, AND USE OF, THE SITES
        ...
        <p>
          ...
          effect while you use the Sites. We may suspend or terminate your
          rights to use the Sites (including your Account) at any time for any
          reason at our sole discretion, including for any use of the Sites in
          violation of these Terms. Upon termination of your rights under these
          Terms, your Account and right to access and use the Sites will
          terminate immediately. Company will not have any liability whatsoever
          to you for any termination of your rights under these Terms, including
          for termination of your Account. Even after your rights under these
        ...
        <p>
          ...
          by prominently posting notice of the changes on our Sites. You are
          ...
          upon the earlier of thirty (30) calendar days following our dispatch
          of an e-mail notice to you (if applicable) or thirty (30) calendar
          days following our posting of notice of the changes on our Sites.
          These changes will be effective immediately for new users of our
          Sites. Continued use of our Sites following notice of such changes
          shall indicate your acknowledgement of such changes and agreement to
          be bound by the terms and conditions of such changes.<br />Dispute
        ...
        <p>
          ...
          party a written Notice of Dispute (“Notice”) describing the nature and
          basis of the claim or dispute, and the requested relief. A Notice to
          the Company should be sent to: 8171 Brittany Drive, Dublin,
          California, 94568. After the Notice is received, you and the Company
        ...
        <p>
          ...
          governing the arbitration are available online at<a
            href="http://www.adr.org/"
          >
            www.adr.org</a
          >
          or by calling the AAA at 1-800-778-7879. The arbitration shall be
        ...
        <p>
          ...
          within United States County, California, for such purpose
        </p>
        <p>
          Export. The Sites may be subject to U.S. export control laws and may
        ...
        <p>
          ...
          use electronic means, whether you use the Sites or send us emails, or
          whether Company posts notices on the Sites or communicates with you
          ...
          rights.<br />Entire Terms. These Terms constitute the entire agreement
          between you and us regarding the use of the Sites. Our failure to
          ...
          assignees.<br />Copyright/Trademark Information. Copyright © 2020
          Injective Labs Inc. All rights reserved. All trademarks, logos and
          service marks (“Marks”) displayed on the Sites are our property or the
        ...
        <p>E-Mail: Contact@InjectiveProtocol.com</p>
      </div>
    </div>
  </article>
</template>
